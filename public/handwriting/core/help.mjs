  ...
  dialog.innerHTML = `
    ...
    <div class="help-content">
      ...
      <details><summary>保存・スタンプにする</summary>
        <p>${integrated ? '右上の「保存」は、続きを描ける作品をこの端末に残します。「履歴」ではプレビューや名前から作品を選んで開けます。ボードに貼るマイステッカー画像とは別の保存です。' : '右上の「保存」は、続きを描くためのファイルをダウンロードします。「保存した続きを開く」でそのファイルを選ぶと再開できます。'}</p>
